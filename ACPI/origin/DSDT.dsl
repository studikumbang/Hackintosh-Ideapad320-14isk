 ...
 *
 * Disassembly of iASLzHoDfa.aml, Tue Aug 17 13:02:44 2021
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7FF6C018, 0x070F)
    ...
    OperationRegion (OGNS, SystemMemory, 0x7FF6CFD8, 0x0000000C)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
            ...
            Scope (\)
            {
                OperationRegion (LFCN, SystemMemory, 0x7F88DE58, 0x00E8)
    ...
    OperationRegion (MDBG, SystemMemory, 0x7FF59018, 0x00001004)
